...
<body>
	...
	<div class="containerlist"><br>
		<span style="color: #005200;"><h2>Services Listings</h2></span><br>
		<br>
        <div class="imglist">
		<?php 
            $query_services = "SELECT * FROM product WHERE tags = 'Services'";
            ...
            <form method="post" action="serviceslistings.php?ids=<?php echo $ids; ?>&id=<?=$row['productID'] ?>">
